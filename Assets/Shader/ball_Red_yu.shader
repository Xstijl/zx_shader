...
////// Emissive:
                ...
                float node_9318_if_leA = step(dot(normalize((i.normalDir+_highlight_offset1_var.rgb)),lightDirection),_highlight_range1_var);
                float node_9318_if_leB = step(_highlight_range1_var,dot(normalize((i.normalDir+_highlight_offset1_var.rgb)),lightDirection));
                float node_6251 = 0.0;
                float node_2266 = 1.0;
                ...
                float node_3509_if_leA = step(dot(normalize((i.normalDir+_highlight_offset2_var.rgb)),lightDirection),_highlight_range2_var);
                float node_3509_if_leB = step(_highlight_range2_var,dot(normalize((i.normalDir+_highlight_offset2_var.rgb)),lightDirection));
                float4 _Fresnel_color_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Fresnel_color );
                float3 emissive = saturate((1.0-(1.0-lerp(_node_9147_var.rgb,_highlight_color_var.rgb,saturate(max(lerp((node_9318_if_leA*node_6251)+(node_9318_if_leB*node_2266),node_6251,node_9318_if_leA*node_9318_if_leB),lerp((node_3509_if_leA*node_6251)+(node_3509_if_leB*node_2266),node_6251,node_3509_if_leA*node_3509_if_leB)))))*(1.0-(pow(1.0-max(0,dot(normalDirection, viewDirection)),8.0)*_Fresnel_color_var.rgb))));
